...
namespace sberdev.SBContracts.Constants.Docflow
{
  ...
  {
    [Sungero.Core.Public]
    public const string ReadressStage = "55d13a81-9812-42e9-ab13-08f849fed4bd"; // "Этап переадресации
    [Sungero.Core.Public]
    ...
    [Sungero.Core.Public]
    public const string SignApproveStage = "3236816c-cb3c-467a-bd50-12fd0accab6a"; // этап согласования-подписания
  }
}