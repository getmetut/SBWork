...
namespace sberdev.SBContracts
{
  partial class IncomingLetterClientHandlers
  {
    ...
    {
      base.Refresh(e);
      var analiticSetup = SberContracts.AnaticsSetups.GetAll(r => (r.DocumentType == SberContracts.AnaticsSetup.DocumentType.IncomingLetter) && (r.DocumentKind == _obj.DocumentKind)).FirstOrDefault();
