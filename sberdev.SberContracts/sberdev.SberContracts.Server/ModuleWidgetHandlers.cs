...
{
  partial class ApprovalAnalyticsWidgetHandlers
  {

    public virtual void GetApprovalAnalyticsAssignAvgApprTimeByDepartWidgetValue(Sungero.Domain.GetWidgetBarChartValueEventArgs e)
    {
      try
      {
        ...
        var departmentStats = PublicFunctions.WidgetCache.GetAssignAvgApprTimeCacheData(
          ...
          _parameters.AnalysisPeriod.Value.ToLower());
    ...
    public virtual void GetApprovalAnalyticsAssignCompletedByDepartWidgetValue(Sungero.Domain.GetWidgetBarChartValueEventArgs e)
    {
      try
      {
        var dateRange = PublicFunctions.Module.GenerateCompletedDateRanges(
    ...
    public virtual void GetApprovalAnalyticsTaskDeadlineWidgetValue(Sungero.Domain.GetWidgetPlotChartValueEventArgs e)
    {
      try
      {
    ...
    public virtual void GetApprovalAnalyticsTaskFlowWidgetValue(Sungero.Domain.GetWidgetBarChartValueEventArgs e)
    {
      try
      {
