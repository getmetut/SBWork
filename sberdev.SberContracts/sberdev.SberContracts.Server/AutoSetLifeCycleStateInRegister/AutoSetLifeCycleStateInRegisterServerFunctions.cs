...
using sberdev.SberContracts.AutoSetLifeCycleStateInRegister;

namespace sberdev.SberContracts.Server
{
  partial class AutoSetLifeCycleStateInRegisterFunctions
  {
    public override Sungero.Docflow.Structures.ApprovalFunctionStageBase.ExecutionResult Execute(Sungero.Docflow.IApprovalTask approvalTask)
    {
      ...
      try
      {
        ...
        invoice.LifeCycleState = SBContracts.IncomingInvoice.LifeCycleState.InPayRegister;
