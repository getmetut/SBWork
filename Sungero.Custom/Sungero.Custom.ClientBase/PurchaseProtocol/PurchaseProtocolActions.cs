...
namespace Sungero.Custom.Client
{
  ...
  {
    public virtual void SendToTask(Sungero.Domain.Client.ExecuteActionArgs e)
    {
       _obj.Save();
    ...
    public virtual bool CanSendToTask(Sungero.Domain.Client.CanExecuteActionArgs e)
    {
      return true;
    }
